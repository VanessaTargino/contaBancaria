...
export function sobre(): void {
    ...
    console.log("LinkedIn: https://www.linkedin.com/in/vanessa-targino/");
    console.log("Vanessa Targino - targino.so.vanessa@gmail.com");
    console.log("https://github.com/VanessaTargino");
    console.log("*****************************************************");
}
